								...
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-lg-5">
												<input type="text" class="form-control" name="inputNoKK" id="inputNoKK"  value="<?php echo ($nokk ? $nokk : "");?>">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-lg-5">
												<input type="text" class="form-control" name="inputNoAkta" id="inputNoAkta"  value="<?php echo ($noakta ? $noakta : "");?>">
											</div>
										</div>
										<div class="form-group">
